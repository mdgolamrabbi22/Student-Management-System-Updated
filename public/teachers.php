    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-16">
            ...
            <div class="max-w-4xl mx-auto text-justify text-gray-700 leading-relaxed">
                <p class="mb-4">
                    At Barishal Polytechnic Institute, our faculty is the heart of our academic excellence. They are not
                    just teachers, but mentors and innovators dedicated to shaping the next generation of engineers and
                    technologists. Our instructors bring a wealth of real-world experience and a passion for education
                    to the classroom, ensuring every student receives a high-quality, practical education.
                </p>
                <p>
                    We believe in a hands-on approach to learning, and our faculty members are committed to fostering an
                    environment where curiosity thrives and creativity is celebrated. Get to know the brilliant minds
                    who inspire our students every day.
                </p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    <?php foreach ($deptTeachers as $t):
                        ...
                        <div class="teacher-card text-center bg-gray-50 rounded-xl shadow-md overflow-hidden"
                            ...
                            <div class="p-6">
                                <h3 class="font-bold text-xl text-gray-800 mb-1"><?php echo htmlspecialchars($t['name']); ?>
                                </h3>
                                <p class="text-blue-600 font-semibold text-sm">
                                    <?php echo htmlspecialchars($t['designation']); ?></p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="p-6 bg-gray-50 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-600">
                        Building the world of tomorrow with practical skills in construction, infrastructure, and
                        structural design.
                    </p>
                </div>
                <div class="p-6 bg-gray-50 rounded-xl shadow-md text-center">
                ...
                <div class="p-6 bg-gray-50 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-sm text-gray-600">
                        Pioneering the future with cutting-edge programming, software development, and networking
                        courses.
                    </p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mt-16">
            ...
            <div class="text-gray-700 max-w-4xl mx-auto">
                ...
                <p class="mb-6">
                    To be the leading polytechnic institute in Bangladesh, producing highly skilled, innovative, and
                    ethically sound professionals who can meet the challenges of the modern industrial world and
                    contribute to national development.
                </p>
                <h3 class="text-xl font-semibold text-blue-700 mb-2">Mission</h3>
                <ul class="list-disc list-inside space-y-2">
                    <li>To provide quality technical education and hands-on training that aligns with industry demands.
                    </li>
                    <li>To foster a learning environment that encourages creativity, critical thinking, and
                        problem-solving skills.</li>
                    <li>To ensure students are equipped with professional values, communication skills, and leadership
                        qualities.</li>
