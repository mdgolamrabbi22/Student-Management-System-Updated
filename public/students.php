...
<body class="text-gray-800 font-inter">
    ...
    <!-- Navbar -->
    <nav class="sticky top-0 z-50 bg-white shadow-md py-[10px] px-4 md:px-8 flex justify-between items-center">
        <!-- Logo -->
        ...
        <div class="flex items-center space-x-4 relative">
            ...
            <div id="loginDropdown"
                class="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-xl py-2 z-50 hidden">
    ...
    <div id="mobileMenu" class="mobile-menu-container fixed top-14 left-0 w-full bg-white shadow-lg p-5 z-40 md:hidden">
        ...
        <a href="students.php" class="block py-3 text-gray-600 hover:text-blue-600 border-b border-gray-100">Students</a>
        ...
        <div id="mobileLoginDropdown" class="mt-4 hidden">
            ...
            <a href="teacher-login.php" class="block w-full text-center py-2 text-gray-600 font-medium hover:bg-gray-100 border-b border-gray-100">Teacher Login</a>
            <a href="admin_login.php" class="block w-full text-center py-2 text-gray-600 font-medium hover:bg-gray-100">Admin Login</a>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('click', (event) => {
            if (isDropdownOpen && !loginDropdown.contains(event.target) && loginButton && !loginButton.contains(event.target)) {
                loginDropdown.classList.add('hidden');
